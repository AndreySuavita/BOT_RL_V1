...
from environments_fuzzy import EnhancedTradingEnvironmentFuzzy
...
if __name__ == "__main__":
    ...
    # --- Create environments ---
    train_env = EnhancedTradingEnvironmentFuzzy(full_train_data, window_size, time_cycle, scaler)
    test_env = EnhancedTradingEnvironmentFuzzy(test_data, window_size, time_cycle, scaler)
